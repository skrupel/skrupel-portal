...
<input type="hidden" name="spiel_name" value="<?php echo $HTTP_POST_VARS["spiel_name"]; ?>">
<input type="hidden" name="siegbedingungen" value="<?php echo $HTTP_POST_VARS["siegbedingungen"]; ?>">
<input type="hidden" name="zielinfo_1" value="<?php echo $HTTP_POST_VARS["zielinfo_1"]; ?>">
<input type="hidden" name="zielinfo_2" value="<?php echo $HTTP_POST_VARS["zielinfo_2"]; ?>">
<input type="hidden" name="zielinfo_3" value="<?php echo $HTTP_POST_VARS["zielinfo_3"]; ?>">
<input type="hidden" name="zielinfo_4" value="<?php echo $HTTP_POST_VARS["zielinfo_4"]; ?>">
<input type="hidden" name="zielinfo_5" value="<?php echo $HTTP_POST_VARS["zielinfo_5"]; ?>">
<input type="hidden" name="user_1" value="<?php echo $HTTP_POST_VARS["user_1"]; ?>">
<input type="hidden" name="user_2" value="<?php echo $HTTP_POST_VARS["user_2"]; ?>">
<input type="hidden" name="user_3" value="<?php echo $HTTP_POST_VARS["user_3"]; ?>">
<input type="hidden" name="user_4" value="<?php echo $HTTP_POST_VARS["user_4"]; ?>">
<input type="hidden" name="user_5" value="<?php echo $HTTP_POST_VARS["user_5"]; ?>">
<input type="hidden" name="user_6" value="<?php echo $HTTP_POST_VARS["user_6"]; ?>">
<input type="hidden" name="user_7" value="<?php echo $HTTP_POST_VARS["user_7"]; ?>">
<input type="hidden" name="user_8" value="<?php echo $HTTP_POST_VARS["user_8"]; ?>">
<input type="hidden" name="user_9" value="<?php echo $HTTP_POST_VARS["user_9"]; ?>">
<input type="hidden" name="user_10" value="<?php echo $HTTP_POST_VARS["user_10"]; ?>">
<input type="hidden" name="rasse_1" value="<?php echo $HTTP_POST_VARS["rasse_1"]; ?>">
<input type="hidden" name="rasse_2" value="<?php echo $HTTP_POST_VARS["rasse_2"]; ?>">
<input type="hidden" name="rasse_3" value="<?php echo $HTTP_POST_VARS["rasse_3"]; ?>">
<input type="hidden" name="rasse_4" value="<?php echo $HTTP_POST_VARS["rasse_4"]; ?>">
<input type="hidden" name="rasse_5" value="<?php echo $HTTP_POST_VARS["rasse_5"]; ?>">
<input type="hidden" name="rasse_6" value="<?php echo $HTTP_POST_VARS["rasse_6"]; ?>">
<input type="hidden" name="rasse_7" value="<?php echo $HTTP_POST_VARS["rasse_7"]; ?>">
<input type="hidden" name="rasse_8" value="<?php echo $HTTP_POST_VARS["rasse_8"]; ?>">
<input type="hidden" name="rasse_9" value="<?php echo $HTTP_POST_VARS["rasse_9"]; ?>">
<input type="hidden" name="rasse_10" value="<?php echo $HTTP_POST_VARS["rasse_10"]; ?>">
<input type="hidden" name="spieler_admin" value="<?php echo $HTTP_POST_VARS["spieler_admin"]; ?>">
<input type="hidden" name="startposition" value="<?php echo $HTTP_POST_VARS["startposition"]; ?>">
<input type="hidden" name="imperiumgroesse" value="<?php echo $HTTP_POST_VARS["imperiumgroesse"]; ?>">
<input type="hidden" name="geldmittel" value="<?php echo $HTTP_POST_VARS["geldmittel"]; ?>">
<input type="hidden" name="mineralienhome" value="<?php echo $HTTP_POST_VARS["mineralienhome"]; ?>">
<input type="hidden" name="sternendichte" value="<?php echo $HTTP_POST_VARS["sternendichte"]; ?>">
<input type="hidden" name="mineralien" value="<?php echo $HTTP_POST_VARS["mineralien"]; ?>">
<input type="hidden" name="spezien" value="<?php echo $HTTP_POST_VARS["spezien"]; ?>">
<input type="hidden" name="max" value="<?php echo $HTTP_POST_VARS["max"]; ?>">
<input type="hidden" name="wahr" value="<?php echo $HTTP_POST_VARS["wahr"]; ?>">
<input type="hidden" name="lang" value="<?php echo $HTTP_POST_VARS["lang"]; ?>">
<input type="hidden" name="instabil" value="<?php echo $HTTP_POST_VARS["instabil"]; ?>">
<input type="hidden" name="stabil" value="<?php echo $HTTP_POST_VARS["stabil"]; ?>">
<input type="hidden" name="leminvorkommen" value="<?php echo $HTTP_POST_VARS["leminvorkommen"]; ?>">
<input type="hidden" name="umfang" value="<?php echo $HTTP_POST_VARS["umfang"]; ?>">
<input type="hidden" name="struktur" value="<?php echo $HTTP_POST_VARS["struktur"]; ?>">
<input type="hidden" name="modul_0" value="<?php echo $HTTP_POST_VARS["modul_0"]; ?>">
<input type="hidden" name="modul_2" value="<?php echo $HTTP_POST_VARS["modul_2"]; ?>">
<input type="hidden" name="modul_3" value="<?php echo $HTTP_POST_VARS["modul_3"]; ?>">
<input type="hidden" name="out" value="<?php echo $HTTP_POST_VARS["out"]; ?>">
<input type="hidden" name="nebel" value="<?php echo $HTTP_POST_VARS["nebel"]; ?>">

<input type="hidden" name="piraten_mitte" value="<?php echo $HTTP_POST_VARS["piraten_mitte"]; ?>">
<input type="hidden" name="piraten_aussen" value="<?php echo $HTTP_POST_VARS["piraten_aussen"]; ?>">
<input type="hidden" name="piraten_min" value="<?php echo $HTTP_POST_VARS["piraten_min"]; ?>">
<input type="hidden" name="piraten_max" value="<?php echo $HTTP_POST_VARS["piraten_max"]; ?>">


<? if ($HTTP_POST_VARS["siegbedingungen"]==6) { ?>
<input type="hidden" name="team1" value="<?php echo $HTTP_POST_VARS["team1"]; ?>">
<input type="hidden" name="team2" value="<?php echo $HTTP_POST_VARS["team2"]; ?>">
<input type="hidden" name="team3" value="<?php echo $HTTP_POST_VARS["team3"]; ?>">
<input type="hidden" name="team4" value="<?php echo $HTTP_POST_VARS["team4"]; ?>">
<input type="hidden" name="team5" value="<?php echo $HTTP_POST_VARS["team5"]; ?>">
<input type="hidden" name="team6" value="<?php echo $HTTP_POST_VARS["team6"]; ?>">
<input type="hidden" name="team7" value="<?php echo $HTTP_POST_VARS["team7"]; ?>">
<input type="hidden" name="team8" value="<?php echo $HTTP_POST_VARS["team8"]; ?>">
<input type="hidden" name="team9" value="<?php echo $HTTP_POST_VARS["team9"]; ?>">
<input type="hidden" name="team10" value="<?php echo $HTTP_POST_VARS["team10"]; ?>">
<? } ?>
<br><br><br><br><br>
<center>
