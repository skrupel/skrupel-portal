...
//for ($i=0;$i<50;$i++) {
    ...
    if ($_POST['mineralien'] == 1) {
        $minrand = 1000;
        $maxrand = 7000;
    } elseif ($_POST['mineralien'] == 2) {
        $minrand = 800;
        $maxrand = 5000;
    } elseif ($_POST['mineralien'] == 3) {
        $minrand = 500;
        $maxrand = 3500;
    } elseif ($_POST['mineralien'] == 4) {
        $minrand = 100;
        $maxrand = 1500;
    }
...
if ($_POST['stabil'] >= 1) {
    if ($_POST['stabil'] <= 5) {
        $anzahl = $_POST['stabil'];
    } elseif ($_POST['stabil'] == 6) {
        $anzahl = 1;
    } elseif ($_POST['stabil'] == 7) {
        $anzahl = 2;
    } elseif ($_POST['stabil'] == 8) {
        $anzahl = 1;
    } elseif ($_POST['stabil'] == 9) {
        $anzahl = 2;
    } elseif ($_POST['stabil'] == 10) {
        $anzahl = 2;
    } elseif ($_POST['stabil'] == 11) {
        $anzahl = 1;
    } elseif ($_POST['stabil'] == 12) {
        $anzahl = 1;
    } elseif ($_POST['stabil'] == 13) {
        $anzahl = 2;
    }
    ...
    for ($i = 0; $i < $anzahl; $i++) {
        ...
        while ($ok == 1) {
            ...
            if ($_POST['stabil'] <= 5) {
                ...
                $x = mt_rand(50, ($umfang / 2) - 50);
                $y = mt_rand(50, $umfang - 100);
            } elseif (($_POST['stabil'] == 10) and ($i == 0)) {
                $x = mt_rand(50, $umfang - 100);
                $y = mt_rand(50, ($umfang / 2) - 50);
            } elseif (($_POST['stabil'] == 10) and ($i == 1)) {
                $x = mt_rand(50, ($umfang / 2) - 50);
                $y = mt_rand(50, $umfang - 100);
            } elseif ($_POST['stabil'] == 11) {
                $x = mt_rand(50, ($umfang / 2) - 50);
                ...
                $y = mt_rand(50, ($umfang / 2) - 50);
            } elseif (($_POST['stabil'] == 13) and ($i == 0)) {
                $x = mt_rand(50, ($umfang / 2) - 50);
                $y = mt_rand(50, ($umfang / 2) - 50);
            } elseif (($_POST['stabil'] == 13) and ($i == 1)) {
                $x = mt_rand(($umfang / 2) + 50, $umfang - 100);
                $y = mt_rand(50, ($umfang / 2) - 50);
            }
...
?>
    ...
    <br><br>
    <br><br><br><br><br>
    <center><?php echo $lang['admin']['spiel']['alpha']['fertig']; ?> </center>
<?php
