...
require ($skrupel_path."lang/de/lang.admin.spiel_beta.php");
...
$page_name="Spiel bearbeiten";
require_once ("inc/_header.php");
?>
<center><table border="0" cellspacing="0" cellpadding="4"><tr><td><h1><?php echo $lang['admin']['spiel']['beta']['spiel_bearbeiten']?></h1></td></tr></table></center>
<?php
  ...
  if ($spielanzahl>=1) {
   ?><center><table border="0" cellspacing="0" cellpadding="5">
      <tr>
        ...
        <td><img src="<?php echo $skrupel_path; ?>bilder/empty.gif" height="22" width="1"></td>
      </tr>
   <?php
  ...
  $spieler_10_raus=$array["spieler_10_raus"];
   ...
   ?>
    <tr>
     ...
     <tr><td><form name="formular"  method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>?fu=2&slot_id=<?php echo $slot_id; ?>"></td>
...
?>
<center><table border="0" cellspacing="0" cellpadding="4"><tr><td><h1><?php echo str_replace('{1}',$name,$lang['admin']['spiel']['beta']['bearbeiten_spiel']);?></h1></td></tr></table></center>
...
<center><table border="0" cellspacing="0" cellpadding="4"><tr><td><h1><?php echo $lang['admin']['spiel']['beta']['aktionen']?></h1></td></tr></table></center>
<br>
<center>
<table border="0" cellspacing="0" cellpadding="0">
     <tr><td><form name="formular"  method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>?fu=4&slot_id=<?php echo $spiel; ?>"></td>
...
<?php /* ?> 
<tr><td>
<center><table border="0" cellspacing="0" cellpadding="4"><tr><td><h1><?php echo $lang['admin']['spiel']['beta']['mitspieler']?></h1></td></tr></table></center>
</td></tr>
...
<center><table border="0" cellspacing="0" cellpadding="4"><tr><td style="font-size:20px; font-weight:bold; filter:DropShadow(color=black, offx=2, offy=2)"><?php echo $lang['admin']['spiel']['beta']['optionen']?></td></tr></table></center>
   ...
   <tr><td><form name="formular"  method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>?fu=3&slot_id=<?php echo $spiel; ?>">&nbsp;</td></tr>
	...
	<center><table border="0" height="100%" cellspacing="0" cellpadding="0">
		<tr>
			...
			<center><table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><form name="formular"  method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>?fu=2&slot_id=<?php echo $spiel;?>"></td>
...
<script language=JavaScript>
  window.location='<?php echo $_SERVER["PHP_SELF"]; ?>?fu=5&slot_id=<?php echo $spiel; ?>';
 </script>
<?php
 include ("inc/_footer.php");
 }
...
$main_verzeichnis=$skrupel_path;
include ($skrupel_path."inhalt/inc.host.php");
