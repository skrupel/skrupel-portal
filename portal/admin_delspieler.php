...
require ($skrupel_path."lang/de/lang.admin.mitspieler_gamma.php");
...
$page_name="Spieler entfernen";
require_once ("inc/_header.php");

if ($_GET["fu"]==1) {
?>
<center><table border="0" cellspacing="0" cellpadding="4"><tr>
<td><h1>Mitspieler loeschen</h1></td>
</tr></table></center>
<?php
...
<?php if ($spielanzahl>=1) { ?>
     ...
     <td></td></tr>
<?php } else { ?>
     <tr><td><form name="formular"  method="post" action="admin_delspieler.php?fu=2&spieler_id=<?php echo $id; ?>" onsubmit="return confirm('<?php echo str_replace('{1}',$nick,$lang['admin']['mitspieler']['gamma']['wirklich']);?>');"></td>
