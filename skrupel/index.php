...
///////////////////////////////////////////////////////////////////////////////////////////////
		...
		<html>
			<head>
				...
				<meta name="keywords" content="online, game, weltall, gratis">
			</head>
...
header('Location: '.$portal_path.'index.php');
exit;
		?>
		<html>
			<head>
				<title>Space-Pirates - Das Universum ruft!</title>
				<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
				<meta name="DC.publisher" content="Till Affeldt">
	...
	<html>
		<head>
			<title>Skrupel - Tribute Compilation | Fehler!</title>
			<link rel="shortcut icon" href="/favicon.ico" type="image/x-icon">
			<meta name="DC.publisher" content="Till Affeldt">
			<meta name="robots" content="noindex, follow">
			<meta name="keywords" content="online, game, weltall, gratis">
		...
		<body text="#000000" scroll="no" bgcolor="#000000" background="<?php echo $bildpfad?>/hintergrund.gif" link="#000000" vlink="#000000" alink="#000000" leftmargin="0" rightmargin="0" topmargin="0" marginwidth="0" marginheight="0">
			<center>
				<table border="0" height="100%" cellspacing="0" cellpadding="0">
					<tr><td>Achtung! Es ist ein Fehler im System aufgetreten.<br>Schicke notfalls eine <a href="mailto:korathin@web.de" title="Support">Mail</a> an den Webmaster.
